...
for sub = 1:numSubjects_tls
    try
        EEG = pop_loadset(['subject' num2str(sub) '.set'], '/Users/allan/Documents/MATLAB/LLLT_EEG/SubjectData/tls');
        try
...
for sub = 1:numSubjects_pbo
    try
        EEG = pop_loadset(['subject' num2str(sub) '.set'], '/Users/allan/Documents/MATLAB/LLLT_EEG/SubjectData/pbo');
        try
